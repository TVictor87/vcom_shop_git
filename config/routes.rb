Rails.application.routes.draw do
  ...
  get 'zhenshchinam/:category_url/:product_url', to: 'catalog#show', as: 'women_product_ru', defaults: { url: 'zhenshchinam', column: 'url_ru' }
  ...
  get 'women/:category_url/:product_url', to: 'catalog#show', as: 'women_product_en', defaults: { url: 'women', column: 'url_en' }
  ...
  get 'zhinkam/:category_url/:product_url', to: 'catalog#show', as: 'women_product_uk', defaults: { url: 'zhinkam', column: 'url_en' }
  ...
  get 'muzhchinam/:category_url/:product_url', to: 'catalog#show', as: 'men_product_ru', defaults: { url: 'muzhchinam', column: 'url_ru' }
  ...
  get 'men/:category_url/:product_url', to: 'catalog#show', as: 'men_product_en', defaults: { url: 'men', column: 'url_ru' }
  ...
  get 'cholovikam/:category_url/:product_url', to: 'catalog#show', as: 'men_product_uk', defaults: { url: 'cholovikam', column: 'url_ru' }
  ...
  get 'detyam/:category_url/:product_url', to: 'catalog#show', as: 'child_product_ru', defaults: { url: 'detyam', column: 'url_ru' }
  ...
  get 'child/:category_url/:product_url', to: 'catalog#show', defaults: { url: 'child', column: 'url_ru' }
  ...
  get 'dityam/:category_url/:product_url', to: 'catalog#show', defaults: { url: 'dityam', column: 'url_ru' }
