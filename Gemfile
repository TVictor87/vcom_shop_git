...
# Ruby Internationalization and localization solution. Read more: https://github.com/svenfuchs/rails-i18n
gem 'rails-i18n', github: 'svenfuchs/rails-i18n', branch: 'master'
# Use Simple Form for facilitate the creation of forms
gem 'simple_form', github: 'plataformatec/simple_form'
# Use ClientSideValidations for validation
